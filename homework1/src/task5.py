...
if __name__ == "__main__":
    ...
    print(f"ID of StudentName5: student_database[\"StudentName5\"] = {student_database["StudentName5"]}")
    print(f"ID of StudentName1: student_database[\"StudentName1\"] = {student_database["StudentName1"]}\n")
